...
protocol MealSelectionDelegate: class {
    func mealSelected(_ newMeal: Meal)
}
...
class SearchTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        meals = GlobalVariables.mealList
        print(meals.count)
    ...
    // MARK: - Table view data source
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.cuisineLabel.text = meal.cuisine
...
//        delegate?.mealSelected(selectedMeal)
